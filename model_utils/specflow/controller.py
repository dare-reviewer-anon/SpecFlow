...
class DAREController(nn.Module):
    ...
    def route(
        ...
        *,
        ...
        loss_dict = {
            "specflow_ratio_loss": total_ratio,
            "specflow_soft_loss": total_soft,
            "specflow_hard_loss": total_hard,
        }
...
def attach_specflow_to_anole(model: nn.Module, controller: DAREController):
    ...
    for idx, block in enumerate(blocks):
        ...
        if isinstance(attn, nn.Module):
            ...
            setattr(wrapped.base_attn, "specflow_controller", controller)
            setattr(wrapped.base_attn, "specflow_layer_idx", idx)
